# Checklist — Change 029

- [x] Estado inicial e fontes canônicas conferidos.
- [x] Rota planejada registrada.
- [x] Breaking changes e documentação atual do Supabase verificados.
- [x] Migration local criada pela CLI oficial.
- [x] Teste pgTAP local criado pela CLI oficial.
