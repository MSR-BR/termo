# Critérios de aceite — Change 031

- [x] O vídeo copiado é byte a byte igual ao arquivo recebido.
- [x] A landing apresenta o vídeo com controles e sem reprodução automática.
- [x] O vídeo vertical não é cortado em desktop ou mobile.
