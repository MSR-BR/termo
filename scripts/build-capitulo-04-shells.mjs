...
const SOURCE_DIR = new URL("../slides/capitulo-04/source/", import.meta.url);
const OUTPUT_DIR = new URL("../slides/capitulo-04/", import.meta.url);

const itemBlocks = [
  {
    id: "4.1",
    title: "Validade do Gás Ideal e Introdução ao Gás de Van der Waals",
    note: "Discussão qualitativa sobre quando o gás ideal deixa de funcionar e por que o modelo de Van der Waals introduz volume molecular finito e interações atrativas.",
    pages: [1],
    aiExercise: false,
    customIntro: true
  },
  {
    id: "4.2",
    title: "Equação de Estado de Van der Waals",
    note: "Motivação para gases reais, correções de volume e pressão, e forma final da equação de estado.",
    pages: [2, 3, 4, 5],
    aiExercise: true
  },
  {
    id: "4.3",
    title: "Ponto Crítico",
    note: "Condições críticas do gás de Van der Waals e interpretação física do ponto crítico.",
    pages: [6],
    aiExercise: true
  },
  {
    id: "4.4",
    title: "Equação de Estado Reduzida",
    note: "Variáveis reduzidas, universalidade da equação de Van der Waals e fator de compressibilidade crítico.",
    pages: [7, 8],
    aiExercise: true
  },
  {
    id: "4.5",
    title: "Instabilidade Mecânica e Espinodal",
    note: "Isotermas reduzidas, regiões instáveis e a curva espinodal nas transições líquido-vapor.",
    pages: [9, 10],
    aiExercise: true
  },
  {
    id: "4.6",
    title: "Energia Livre de Helmholtz e Gibbs",
    note: "Critérios de estabilidade e coexistência de fases a partir das energias livres de Helmholtz e Gibbs.",
    pages: [11, 12],
    aiExercise: true
  },
  {
    ...
    note: "Regra das áreas iguais, coexistência líquido-vapor, regra da alavanca e aplicação ao dióxido de carbono.",
    pages: [13, 14, 15],
    aiExercise: true
  },
  {
    id: "4.8",
    title: "Superaquecimento e Super-resfriamento",
    note: "Estados metaestáveis, nucleação e limites de estabilidade em transições de fase.",
    pages: [16],
    aiExercise: true
  },
  {
    id: "4.9",
    title: "Calor Latente e Equação de Clausius-Clapeyron",
    note: "Calor latente, inclinação da curva de coexistência e aplicações da equação de Clausius-Clapeyron.",
    pages: [17, 18, 19],
    aiExercise: true
  },
  {
    id: "4.10",
    title: "Compressibilidade Isotérmica",
    note: "Resposta volumétrica à pressão, divergência no ponto crítico e interpretação da compressibilidade isotérmica.",
    pages: [20],
    aiExercise: true
  },
  {
    ...
    note: "Coeficiente de expansão térmica, resposta à temperatura e comportamento próximo ao ponto crítico.",
    pages: [21],
    aiExercise: true
  }
];
...
const CALLOUT_RE = /(note|tip|insight|provoca|provocation|warning|summary|highlight|accent|alert|badge|result|conclusion|analogy|reflection|reflex)/i;
const HEADING_RE = /(heading|header|title|sub-heading|subheading|label)/i;
const TITLE_REGION_RE = /(title-region|title-section|title-main|main-slide-title|main-cover-title|page-title|slide-main-heading|beta-title|cover-section-label|cover-main-title|cover-chapter-badge|cover-author|horizontal-divider|top-nav|nav-header|navigation-bar|page-counter|breadcrumbs)/i;
...
function renderQualitativeIntroContent() {
  return "<section class=\"card\">\n<div class=\"card-title\">\n<i class=\"fa-solid fa-circle-question\"></i>\nQuando o gás ideal deixa de ser uma boa descrição?\n</div>\n<div class=\"body-text\">\n<p>O gás ideal é uma excelente aproximação para vapores muito diluídos, mas falha quando a distância média entre moléculas diminui ou quando a energia térmica não é suficiente para tornar desprezíveis as forças intermoleculares.</p>\n<div class=\"highlight\">A ideia central é simples e poderosa: volume finito e atração molecular transformam um gás ideal em um fluido capaz de apresentar instabilidade, ponto crítico e transições de fase.</div>\n</div>\n</section>\n\n<div class=\"grid\">\n<section class=\"card\">\n<div class=\"card-title\">\n<i class=\"fa-solid fa-compress\"></i>\nAlta pressão\n</div>\n<div class=\"body-text\">\n<p>Ao comprimir o gás, o volume próprio das moléculas passa a ocupar uma fração relevante do volume total. A hipótese de partículas pontuais deixa de ser aceitável.</p>\n</div>\n</section>\n\n<section class=\"card\">\n<div class=\"card-title green\">\n<i class=\"fa-solid fa-temperature-low\"></i>\nBaixa temperatura\n</div>\n<div class=\"body-text\">\n<p>Com menor energia cinética, as atrações intermoleculares se tornam importantes. O gás pode condensar, entrando em uma transição de fase ausente no modelo ideal.</p>\n</div>\n</section>\n</div>\n\n<div class=\"grid\">\n<section class=\"card\">\n<div class=\"card-title purple\">\n<i class=\"fa-solid fa-ruler-combined\"></i>\nCorreção de volume\n</div>\n<div class=\"body-text\">\n<p>Van der Waals reduz o volume disponível ao movimento molecular, incorporando o espaço excluído pelas partículas reais.</p>\n</div>\n</section>\n\n<section class=\"card\">\n<div class=\"card-title purple\">\n<i class=\"fa-solid fa-gauge-high\"></i>\nCorreção de pressão\n</div>\n<div class=\"body-text\">\n<p>As forças atrativas diminuem a pressão exercida nas paredes. A equação corrige esse efeito e abre caminho para descrever liquefação e coexistência líquido-vapor.</p>\n</div>\n</section>\n</div>";
}
...
<link rel="stylesheet" href="../../assets/termo-auth.css?v=0625.2">
<link rel="stylesheet" href="../../assets/capitulo-02-layout.css?v=0611.4">
<script defer src="../../assets/termo-auth.js?v=0625.2"></script>
...
<a href="../../index.html?chapter=04" class="index-back-button">
...
async function assertAllSourcesExist() {
  ...
  for (let page = 1; page <= 21; page += 1) {
    if (!files.has(`page_${page}.html`)) {
      throw new Error(`Fonte ausente: slides/capitulo-04/source/page_${page}.html`);
    }
  }
}
...
for (const block of itemBlocks) {
  const content = block.customIntro ? renderQualitativeIntroContent() : await renderItemContent(block.pages);
