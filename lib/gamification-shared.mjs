...
export const GAMIFICATION_PROFILE_CONTRACT_VERSION = "termo-gamification-profile/1.0.0";
export const GAMIFICATION_POLICY_VERSION = "termo-gamification-policy/1.0.0";
...
export function mapProfileRowToJourneyProfile(user = {}, row = {}, options = {}) {
  ...
  return {
    ...
    snapshot: {
      ...
      policyVersion: String(row.policy_version || "legacy-phase-1c"),
